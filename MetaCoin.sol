...
contract MetaCoin {
	...
	function getInfoPrevious(address receiver) public returns(string memory,uint,string memory){
	...
	function getTransactionByID(string memory id) public returns(uint,string memory,address) {
    ...
    function GetLocation(uint8 TrailNo) public returns (string memory,uint,address)
    {
